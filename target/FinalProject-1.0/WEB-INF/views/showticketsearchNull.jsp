...
<!-- 			<div class="card"> -->
<!-- 				<div id="timeSliderCardHeader" class="card-header">縮小時間範圍搜索</div> -->
<!-- 				<div class="card-body"> -->
<!-- 					<iframe id="timeSliderIFrame" src="TimeSlider.jsp"></iframe> -->
<!-- 				</div> -->
<!-- 			</div> -->
			<div class="card">
				<div id="selectByAirlineCardHeader" class="card-header">根據航空公司分類</div>
		...
		<label style="margin:150px">查無符合資料</label>
					...
					<div class="card-header">
						<div class="row" style="height:25px">
							...
							<div id="pricePerTicketCardHeader" class="col-sm-6">
								...
								<label
									style="font-size: 25px; font-family: 微軟正黑體; color: red; font-weight: bold;">NT$${ticketsearchresults.EquivFareAdult}</label>/每成人
							</div>
						</div>
					</div>
...
// 			var scheduleGoI = iframe.contentWindow.document
// 					.getElementById("scheduleGo");
// 			var scheduleBackI = iframe.contentWindow.document
// 					.getElementById("scheduleBack");
// 			scheduleGoI.innerText = scheduleGo;
// 			scheduleBackI.innerText = scheduleBack;

// 			var sliderRange1 = iframe.contentWindow.document
// 					.getElementById("slider-range1");
// 			sliderRange1.onslidechange = function() {
// 				var text = iframe.contentWindow.document
// 						.getElementById("amount1").value;
...
// 					pDepGo[i - 1] = 0;
// 					var timeObj = document
// 							.getElementById("departureTimeGo" + i);
...
// 						pDepGo[i - 1] = 1;
// 						if (pAir[i - 1] + pDepGo[i - 1] + pArrGo[i - 1]
// 								+ pDepBack[i - 1] + pArrBack[i - 1] == 5) {
...
// 			var sliderRange2 = iframe.contentWindow.document
// 					.getElementById("slider-range2");
// 			sliderRange2.onslidechange = function() {
// 				var text = iframe.contentWindow.document
// 						.getElementById("amount2").value;
// 				var sHourB = parseInt(text.substr(0, 2));
// 				var sMinB = parseInt(text.substr(3, 2));
// 				var sHourE = parseInt(text.substr(8, 2));
// 				var sMinE = parseInt(text.substr(11, 2));
...
// 			var sliderRange3 = iframe.contentWindow.document
// 					.getElementById("slider-range3");
// 			sliderRange3.onslidechange = function() {
// 				var text = iframe.contentWindow.document
// 						.getElementById("amount3").value;
// 				var sHourB = parseInt(text.substr(0, 2));
// 				var sMinB = parseInt(text.substr(3, 2));
// 				var sHourE = parseInt(text.substr(8, 2));
// 				var sMinE = parseInt(text.substr(11, 2));
...
// 				for (var i = 1; i <= count; i++) {
// 					pDepBack[i - 1] = 0;
// 					var timeObj = document.getElementById("departureTimeBack"
// 							+ i);
// 					var cardID = timeObj.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.id;
// 					var timeText = timeObj.textContent;
// 					var bHour = parseInt(timeText.substr(0, 2));
...
// 			var sliderRange4 = iframe.contentWindow.document
// 					.getElementById("slider-range4");
// 			sliderRange4.onslidechange = function() {
// 				var text = iframe.contentWindow.document
// 						.getElementById("amount4").value;
// 				var sHourB = parseInt(text.substr(0, 2));
// 				var sMinB = parseInt(text.substr(3, 2));
// 				var sHourE = parseInt(text.substr(8, 2));
// 				var sMinE = parseInt(text.substr(11, 2));
...
// 					pArrBack[i - 1] = 0;
// 					var timeObj = document
// 							.getElementById("arrivalTimeBack" + i);
// 					var cardID = timeObj.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.id;
// 					var timeText = timeObj.textContent;
// 					var bHour = parseInt(timeText.substr(0, 2));
// 					var bMin = parseInt(timeText.substr(3, 2));
