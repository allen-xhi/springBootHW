package tw.com.jeff.together.dao;
...
public interface NeedDao {
	Integer insertNeedDao(NeedBean bean);
	void updateNeedDao(NeedBean bean);
	List<NeedBean> selectNeedDao(String AccountId);
	NeedBean selectNeedBean(Integer needid);
	List<NeedBean> FilterTripDao(String tripname,String triptype,String countrycity,Integer tripdays,Integer lowestprice,
