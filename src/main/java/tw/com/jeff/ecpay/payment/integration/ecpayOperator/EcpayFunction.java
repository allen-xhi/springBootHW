package tw.com.jeff.ecpay.payment.integration.ecpayOperator;
...
import tw.com.jeff.ecpay.payment.integration.config.EcpayConfig;
...
public class EcpayFunction {
	...
	public final static String httpPost(String url, String urlParameters, String encoding){
		try{
			...
			throw new EcpayException(ErrorMessage.POST_ERROR);
		}
	}
