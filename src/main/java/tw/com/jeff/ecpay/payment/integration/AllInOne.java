...
import tw.com.jeff.ecpay.payment.integration.domain.ATMRequestObj;
...
import tw.com.jeff.ecpay.payment.integration.domain.CVSOrBARCODERequestObj;
...
import tw.com.jeff.ecpay.payment.integration.errorMsg.ErrorMessage;
import tw.com.jeff.ecpay.payment.integration.exception.EcpayException;
import tw.com.jeff.ecpay.payment.integration.verification.VerifyAioCheckOut;
import tw.com.jeff.ecpay.payment.integration.verification.VerifyCapture;
import tw.com.jeff.ecpay.payment.integration.verification.VerifyDoAction;
import tw.com.jeff.ecpay.payment.integration.verification.VerifyFundingReconDetail;
import tw.com.jeff.ecpay.payment.integration.verification.VerifyQueryCreditTrade;
import tw.com.jeff.ecpay.payment.integration.verification.VerifyQueryTrade;
import tw.com.jeff.ecpay.payment.integration.verification.VerifyQueryTradeInfo;
import tw.com.jeff.ecpay.payment.integration.verification.VerifyTradeNoAio;
...
public class AllInOne extends AllInOneBase{
	...
	public String capture(CaptureObj captureObj){
		...
		System.out.println(captureObj.toString());
		String result = "";
		String CheckMacValue = "";
		try {
			...
			result = EcpayFunction.httpPost(captureUrl, httpValue, "BIG5");
